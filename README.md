...
## Overview 
This project is a challenge suggested by Claude and built with HTML, CSS and JavaScript.
Each time you click the button, a random HEX color is generated and applied as the background of the page.
